...
| ---------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Training readiness** | `get_training_readiness(date)`                             | `score` (0–100) + contributors (sleep, recovery time, HRV status, acute load, stress history) | The single best "go / hold back" number. **<25 poor / 25–50 low / 50–75 moderate / 75+ prime.** Low → swap a quality session for easy aerobic or recovery; prime → green-light a key session. |
