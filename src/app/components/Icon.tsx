...
const PATHS: Record<IconName, ReactNode> = {
  today: (
    <>
      ...
      <path d="M12 9v4l2.5 1.5M12 5V3M9 3h6" />
    </>
  ),
  calendar: (
    <>
  ...
  journal: (
    <>
      ...
      <path d="M5 17.5A1.5 1.5 0 016.5 16H19M9 7.5h6M9 11h4" />
    </>
  ),
  run: (
    <>
      <circle cx="14.5" cy="4.5" r="1.8" />
      <path d="M5 21l3-5 3 1.5 1-4.5-3-2 1-4 3 3h3" />
      <path d="M11 13l-2-1.5" />
    </>
  ),
  bike: (
    <>
      ...
      <path d="M6 17l4-7h5l-2.5 7M9 6h3l1.5 4M14 7h3" />
    </>
  ),
  swim: (
    <>
      <circle cx="17" cy="7" r="1.6" />
      <path d="M3 16c1.5-1 2.5-1 4 0s2.5 1 4 0 2.5-1 4 0 2.5 1 4 0M5 14l5-3.5-2-2 4-1.5" />
    </>
  ),
  hike: (
    <>
      <path d="M8 4.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3zM8 9l-2 5 3 1v6M9 13l3 1 2-3 3 1" />
      <path d="M14 21l-1-5" />
    </>
  ),
  ...
  sun: (
    <>
      ...
      <path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5 5l1.5 1.5M19 19l-1.5-1.5M19 5l-1.5 1.5M5 19l1.5-1.5" />
    </>
  ),
  bolt: <path d="M13 2L4 14h7l-1 8 9-12h-7z" />,
  foot: (
    <>
      <path d="M7 5c1.5 0 2.5 2 2.5 5s-1 5-2.5 5-2-2-2-5 .5-5 2-5z" />
      <path d="M11 16c0 2 1 3 2.5 3s2.5-1 2.5-2.5S15 14 14 13" />
    </>
  ),
  ...
  settings: (
    <>
      ...
      <path d="M12 2v3M12 19v3M4 6l2 1.5M18 16.5L20 18M2 12h3M19 12h3M4 18l2-1.5M18 7.5L20 6" />
    </>
  ),
